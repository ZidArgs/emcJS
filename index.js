...
import util_logic_elements_AbstractElement from "./util/logic/elements/AbstractElement.js";
import util_logic_elements_LiteralFalse from "./util/logic/elements/LiteralFalse.js";
import util_logic_elements_LiteralNumber from "./util/logic/elements/LiteralNumber.js";
import util_logic_elements_LiteralTrue from "./util/logic/elements/LiteralTrue.js";
import util_logic_elements_LiteralValue from "./util/logic/elements/LiteralValue.js";
import util_logic_elements_OperatorAnd from "./util/logic/elements/OperatorAnd.js";
import util_logic_elements_OperatorMax from "./util/logic/elements/OperatorMax.js";
import util_logic_elements_OperatorMin from "./util/logic/elements/OperatorMin.js";
import util_logic_elements_OperatorNand from "./util/logic/elements/OperatorNand.js";
import util_logic_elements_OperatorNor from "./util/logic/elements/OperatorNor.js";
import util_logic_elements_OperatorNot from "./util/logic/elements/OperatorNot.js";
import util_logic_elements_OperatorOr from "./util/logic/elements/OperatorOr.js";
import util_logic_elements_OperatorXor from "./util/logic/elements/OperatorXor.js";
...
let index = {
    ...
    "util": {
        ...
        "logic": {
            "elements": {
                "AbstractElement": util_logic_elements_AbstractElement,
                "LiteralFalse": util_logic_elements_LiteralFalse,
                "LiteralNumber": util_logic_elements_LiteralNumber,
                "LiteralTrue": util_logic_elements_LiteralTrue,
                "LiteralValue": util_logic_elements_LiteralValue,
                "OperatorAnd": util_logic_elements_OperatorAnd,
                "OperatorMax": util_logic_elements_OperatorMax,
                "OperatorMin": util_logic_elements_OperatorMin,
                "OperatorNand": util_logic_elements_OperatorNand,
                "OperatorNor": util_logic_elements_OperatorNor,
                "OperatorNot": util_logic_elements_OperatorNot,
                "OperatorOr": util_logic_elements_OperatorOr,
                "OperatorXor": util_logic_elements_OperatorXor
            },
